...
//            $table->dropColumn('recource_id');
//            $table->dropColumn('city_id');
//            $table->dropColumn('email');
//            $table->dropColumn('auth_rource_id');
//            $table->dropColumn('ass_recouse');
...
//            $table->dropColumn('ass_resource');
//            $table->dropColumn('weixin_public_id');
//            $table->dropColumn('self_media_name');
//            $table->dropColumn('self_icon');
//        });
//    }
//}
