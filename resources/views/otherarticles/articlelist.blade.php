...
@section('content')
    <div class="container container-full" ng-app="articleApp">
        <div class="row" ng-controller="articleController">
            <a class="col-md-offset-2 btn btn-default right" href="{{ url('admin/otherarticle/create') }}" target="_blank">New Article</a>
            ...
            <table class="table">
                ...
                @if($articles)
                    {!! Form::open(array('url' => 'admin/otherarticle/groupupdate', 'class'=>'form', 'method'=>'POST')) !!}
                    {!! Form::token() !!}
                    <tbody>
                    @foreach($articles as $article)
                        <tr>
                            ...
                            <td>
                                {!! Form::text('id['.$article->id.']', $article->id , array('class'=>'id input col-md-12', 'hidden')) !!}
                            ...
                            <td><a href="{{ url('admin/otherarticle/'.$article->id.'/edit') }}" target="_blank" class="btn btn-default" id="editBtn_{{ $article->id }}">编辑</a></td>
