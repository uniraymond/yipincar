        ...
        jQuery(document).ready(function(){
            jQuery("input[name='mediatype']").change(function(){
                ...
                if ($(this).val() == 1) {
                    ...
                    $('#ass_resource_upload input').prop('disabled', true).prop({'disabled': true, 'required': false});
                }
                if ($(this).val() == 2) {
                    $('#ass_resource_upload').show();
                    $('#ass_resource_upload input').prop('enabled', true).prop({'enabled': true, 'required': true});
                }
            });
        });
    </script>
