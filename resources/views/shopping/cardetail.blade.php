...
<div class="article-preview" id="prviewbody" contenteditable="false">
    <img src="{{$car->logo}}" style="margin-top: 20px">
        <div class="clearfix"></div>

    <div style="margin: 12px" >
        <div class="title col-xs-12" style="margin-top: 10px">{{$car->fullname}}
            {{--<div class="pull-right" style="color: blue">4.7分</div>--}}
        </div>

        <div class="clearfix"></div>
        <div class="col-xs-5">{{$car->name}}</div><div class="pull-right" style="margin-right: 20px">{{$car->salestate}}</div>
        <div class="clearfix"></div>
