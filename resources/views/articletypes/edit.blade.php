        ...
        <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::text('name', $articletype->name, array('class'=>'name input col-md-12', 'placeholder' => 'Name')) !!}
                    {!! Form::label('description', 'Description', array('class'=>'col-md-12')) !!}
                    {!! Form::text('description', $articletype->description, array('class' => 'description input col-md-12', 'placeholder' => 'Description')) !!}
